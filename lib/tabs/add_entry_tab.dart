          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              children: [
                ...
                const SizedBox(height: 16),
                // Add the content TextFormField here
                TextFormField(
                  maxLines:
                      null, // Allows the input field to expand as user types more lines
                  controller: _contentController,
                  decoration: const InputDecoration(
                    labelText: 'Content', // Label for the content input field
                  ),
                  validator: (value) {
                    if (value == null || value.isEmpty) {
